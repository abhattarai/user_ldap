	...
	*/
	...
	public function groupsMatchFilter($groupDNs) {
		...
		foreach ($groupDNs as $dn) {
			...
			$result = $this->readAttribute($dn, 'cn', $this->connection->__get('ldapGroupFilters'));
			if (\is_array($result)) {
	...
	public function searchUsers($filter, $attr = null, $limit = null, $offset = null) {
		return $this->search($filter, $this->connection->__get('ldapBaseUsers'), $attr, $limit, $offset);
	}
	...
	public function countUsers($filter, $attr = ['dn'], $limit = null, $offset = null) {
		return $this->count($filter, $this->connection->__get('ldapBaseUsers'), $attr, $limit, $offset);
	}
	...
	public function searchGroups($filter, $attr = null, $limit = null, $offset = null) {
		return $this->search($filter, $this->connection->__get('ldapBaseGroups'), $attr, $limit, $offset);
	}
	...
	public function countGroups($filter, $attr = ['dn'], $limit = null, $offset = null) {
		return $this->count($filter, $this->connection->__get('ldapBaseGroups'), $attr, $limit, $offset);
	}
	...
	public function countObjects($limit = null, $offset = null) {
		return $this->count('objectclass=*', $this->connection->__get('ldapBase'), ['dn'], $limit, $offset);
	}
